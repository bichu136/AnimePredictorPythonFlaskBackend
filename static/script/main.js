...
function DoneClick()
{
    ...
    fetch(api_link,{method:"POST",headers:{ 'Content-Type': 'application/json' },body: JSON.stringify({ array:x }) }).then(result=>result.json()).then(data =>alert(data))
}